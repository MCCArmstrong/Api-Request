    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="body">
                    <form id="form_validation" method="POST" action="{{route('product-media.update', $product_info->id )}}">
                        {{ csrf_field() }}
                            <div class="form-group form-float">
                                <label for="">Product Name</label>
                                <input type="text" class="form-control"  name="title" required placeholder="Give a new product name">
                            ...
                            <div class="form-group form-float">
                                <label for="">Edit Product Code</label>
                                <input type="text" class="form-control" placeholder="Give a new code" name=
                            "product_code"  required>
                                <span class="text-danger">{{ $errors->first('product_code') }}</span>
                            </div>
                            <div class="form-group form-float">
                                <label for="">Edit a description</label>
                            ...
                            <div class="form-group form-float">
                                ...
                                @if ($product_info->image)
                                    <img src="{{ url('public/image/'.$product_info->image) }}" 
                                    alt="Check well" width="50" height="50" class="rounded-circle">
                                @endif
                                    <label for="">Product Image</label>
                                 <input type="text" class="form-control"  value="{{ $product_info->image }}">
